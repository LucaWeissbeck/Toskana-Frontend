                  ...
                  <div className="col-md-4 scroll grid-margin stretch-card">
                    <div className="card">
                      <div className="scroll">
                        <div className="card-body video-activity">
                          ...
                          <div style={{maxHeight: "inherit"}}>
                              {this.state?.videoEventData?.slice(0,30).map((event) => {
                                return(
                                  <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3" onClick={() => window.open(event.snapshot.url, "_blank")}>
